...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<middleman-core>.freeze, ["= 4.3.8"])
      s.add_runtime_dependency(%q<middleman-cli>.freeze, ["= 4.3.8"])
      ...
      s.add_dependency(%q<middleman-core>.freeze, ["= 4.3.8"])
      s.add_dependency(%q<middleman-cli>.freeze, ["= 4.3.8"])
